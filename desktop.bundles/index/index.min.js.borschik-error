...
/* begin: ../../desktop.blocks/page/page.js */
...
provide(BEMDOM.decl(this.name, {
    onSetMod: {
        js: {
            inited: function() {
                this._sssr = this.findBlockInside('sssr');
                this._autoscroll = this._sssr.getMod('autoscroll');
                this._sssr.on({ modName: 'autoscroll', modVal: '*'}, function(modName, modVal) {
                    console.log('PAGE: sssr_autoscroll toggled');
                    console.log('modName: ', modName, ', modVal: ', ,modVal);
                });
            }
        }
    }
...
/* end: ../../desktop.blocks/page/page.js */
...
/* begin: ../../desktop.blocks/sssr/sssr.js */
...
provide(BEMDOM.decl(this.name, {
    ...
    onSetMod: {
        ...
        theme: {
            small: function() {
                console.log('theme small enabled');
            },
            yac: function() {
                console.log('theme yac enabled');
            }
        },
    },
...
/* end: ../../desktop.blocks/sssr/sssr.js */
/* begin: ../../desktop.blocks/sssr/_autoscroll/sssr_autoscroll.js */
...
/* end: ../../desktop.blocks/sssr/_autoscroll/sssr_autoscroll.js */